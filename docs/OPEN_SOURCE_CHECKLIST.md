...
This checklist defines the public repository baseline for LLM Arbitrage System. A checked document means the policy is present; it does not claim that every external runtime, release lane, or production control has been exercised.
